...
<p></p>
Experienced in JAVASCRIPT || React || React Native || Vuejs || Nodejs || Python || Expressjs || PHP || LARAVEL || OBJECT ORIENTED (OOP) || HTML || CSS ||  AJAX || MYSQL DATABASE || MongoDb || Redis || Heroku || Digital Ocean 
<p></p>
